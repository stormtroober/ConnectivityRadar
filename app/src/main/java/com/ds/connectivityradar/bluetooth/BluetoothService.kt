...
class BluetoothService(
    ...
    inner class ConnectedThread(private val mmSocket: BluetoothSocket) : Thread() {
        ...
        // Create a handler associated with the Looper of the current thread
        ...
        override fun run() {
            ...
            while (true) {
                ...
                // Send the obtained bytes to the UI activity using the uiHandler.
                uiHandler.post {
        ...
        fun write(bytes: ByteArray) {
            try {
                ...
                Log.e("MyBluetoothService", "Error occurred when sending data", e)
        ...
        fun cancel() {
            try {
                ...
                Log.e("MyBluetoothService", "Could not close the connect socket", e)
            }
        }
    }
}